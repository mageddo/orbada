package pl.mpak.orbada.oracle.edt;
...
public class OrbadaOracleEdtPlugin extends OrbadaPlugin {
  ...
  public String getDescriptiveName() {
    return String.format(stringManager.getString("OrbadaOracleEdtPlugin-description"), new Object[] {getVersion()});
  }
  ...
  public String getVersion() {
    return new VersionID(1, 0, 1, 6).toString();
  }
  ...
  public String getUniqueID() {
    return "orbada-oracle-extend-data-types-plugin";
  }
  ...
  public boolean requires(List<IPlugin> loadedPlugins) {
    ...
    for (IPlugin plugin : loadedPlugins) {
      if (Consts.orbadaOraclePluginId.equals(plugin.getUniqueID())) {
