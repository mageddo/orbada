...
public class OrbadaExportDbfPlugin extends OrbadaPlugin {
  ...
  public String getDescriptiveName() {
    return String.format(stringManager.getString("OrbadaExportDbfPlugin-descriptive-name"), new Object[] {getVersion()});
  }
  ...
  public String getUniqueID() {
    return Consts.orbadaExportDbfPluginId;
  }
