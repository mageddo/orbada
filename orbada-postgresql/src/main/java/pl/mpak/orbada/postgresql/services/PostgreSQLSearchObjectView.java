...
import pl.mpak.orbada.postgresql.gui.util.SearchObjectPanelView;
 ...
 * @author akaluza
 */
public class PostgreSQLSearchObjectView extends ViewProvider {
  ...
  public String getPublicName() {
    return stringManager.getString("PostgreSQLSearchObjectView-public-name");
  }
  
  @Override
  public String getViewId() {
    return "orbada-postgresql-search-objects-view";
  }
  ...
  public String getDescription() {
    return stringManager.getString("PostgreSQLSearchObjectView-description");
  }
