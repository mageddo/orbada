 ...
 * @author akaluza
 */
public class TableColumnPrivilegeListTab extends UniversalPropTab {

  private final StringManager stringManager = StringManagerFactory.getStringManager("postgresql");

  public TableColumnPrivilegeListTab(IViewAccesibilities accesibilities) {
    super(accesibilities);
  }

  @Override
  public String getPanelName() {
    return "postgresql-table-column-privileges";
  }
  ...
  public String getSql(SqlFilter filter) {
    return Sql.getColumnPrivilegeList(filter.getSqlText());
  }
  ...
  public String getTitle() {
    return stringManager.getString("column-privileges");
  }
