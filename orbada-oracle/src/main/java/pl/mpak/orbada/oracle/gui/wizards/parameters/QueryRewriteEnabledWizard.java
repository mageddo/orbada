 ...
 * @author  akaluza
 */
public class QueryRewriteEnabledWizard extends SqlCodeWizardPanel {
  
  private final StringManager stringManager = StringManagerFactory.getStringManager("oracle");

  private Database database;
  
  public QueryRewriteEnabledWizard(Database database) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("QueryRewriteEnabledWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("QueryRewriteEnabledWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "ALTER " +(checkSystem.isSelected() ? "SYSTEM" : "SESSION") +" SET QUERY_REWRITE_ENABLED = " +
  ...
  private void initComponents() {
    ...
    jLabel3.setText(stringManager.getString("query-rewrite-enabled-dd")); // NOI18N

    comboState.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "FALSE", "TRUE", "FORCE" }));
