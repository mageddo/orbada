 ...
 * @author  akaluza
 */
public class PackageDetailsPanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  public PackageDetailsPanel(IViewAccesibilities accesibilities) {
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), indexInfoPanel.getTable(), buttonActions, menuActions, "oracle-package-details-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("PackageDetailsPanel-title");
  }
  ...
  public void refresh() {
    try {
      ...
      indexInfoPanel.refresh(Sql.getObjectInfo(currentSchemaName, currentPackageName));
    } catch (Exception ex) {
