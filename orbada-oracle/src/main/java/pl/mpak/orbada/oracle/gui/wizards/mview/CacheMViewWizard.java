 ...
 * @author  akaluza
 */
public class CacheMViewWizard extends SqlCodeWizardPanel {
  ...
  public CacheMViewWizard(Database database, String schemaName, String viewName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("CacheMViewWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("CacheMViewWizard-tab-title");
  }
