 ...
 * @author  akaluza
 */
public class IndexDetailsPanel extends javax.swing.JPanel implements ITabObjectInfo {
   ...
   */
  public IndexDetailsPanel(IViewAccesibilities accesibilities) {
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), indexInfoPanel.getTable(), buttonActions, menuActions, "oracle-index-details-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("IndexDetailsPanel-title");
  }
  ...
  public void refresh() {
    try {
      ...
      indexInfoPanel.refresh(Sql.getIndexInfo(currentSchemaName, currentIndexName));
    } catch (Exception ex) {
