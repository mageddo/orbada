 ...
 * @author  akaluza
 */
public class RevokePackagePrivilegesWizard extends SqlCodeWizardPanel {
  ...
  public RevokePackagePrivilegesWizard(Database database, String schemaName, String objectName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("RevokePackagePrivilegesWizard-dialog-title");
  }

  public String getTabTitle() {
    return stringManager.getString("RevokePackagePrivilegesWizard-tab-title");
  }
