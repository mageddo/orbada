 ...
 * @author  akaluza
 */
public class PlSqlCcFlagsWizard extends SqlCodeWizardPanel {
  
  private final StringManager stringManager = StringManagerFactory.getStringManager(OrbadaOraclePlugin.class);

  private Database database;
  
  public PlSqlCcFlagsWizard(Database database) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("PlSqlCcFlagsWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("PlSqlCcFlagsWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "ALTER " +(checkSystem.isSelected() ? "SYSTEM" : "SESSION") +" SET PLSQL_CCFLAGS = " +
      "'" +((JTextField)comboState.getEditor().getEditorComponent()).getText() +"'";
  }
  ...
  private void initComponents() {
    ...
    jLabel3.setText(stringManager.getString("plsql-ccflags-dd")); // NOI18N

    comboState.setEditable(true);
    comboState.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "DEMO:TRUE", "DEBUG:TRUE" }));
    ...
    layout.setHorizontalGroup(
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addComponent(comboState, 0, 224, Short.MAX_VALUE))
        .addContainerGap())
    );
