 ...
 * @author  akaluza
 */
public class DropMViewTriggerWizard extends SqlCodeWizardPanel {
  ...
  public DropMViewTriggerWizard(Database database, String schemaName, String objectName, String triggerName) {
  ...
  private void init() {
    ...
    comboView.setModel(new MViewComboBoxModel(database));

    comboView.addItemListener(new MViewItemListener() {
      public void itemChanged(OracleMViewInfo info) {
        ((TriggerComboBoxModel)comboTriggers.getModel()).change(info.getSchema().getName(), info.getName(), "MATERIALIZED VIEW");
      }
    });
  }
  
  public void wizardShow() {
    ((MViewComboBoxModel)comboView.getModel()).change(schemaName);
    ((MViewComboBoxModel)comboView.getModel()).select(objectName, comboView);
    ((TriggerComboBoxModel)comboTriggers.getModel()).select(triggerName, comboTriggers);
  }
  
  public String getDialogTitle() {
    return stringManager.getString("DropMViewTriggerWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("DropMViewTriggerWizard-tab-title");
  }
