...
public class CreateProcedureWizard extends SqlCodeWizardPanel {
  ...
  public CreateProcedureWizard(Database database, String schemaName) {
  ...
  public void wizardShow() {
    ...
    template = new Template(Application.get().getOrbadaDatabase()).loadByName(oracle.getValue(OracleTemplatesSettingsProvider.setProcedure, "oracle-procedure"));
  ...
  public String getSqlCode() {
    ...
    if (template == null) {
      return
        "CREATE PROCEDURE " +SQLUtil.createSqlName(schemaName) +"." +textName.getText() +" " +
