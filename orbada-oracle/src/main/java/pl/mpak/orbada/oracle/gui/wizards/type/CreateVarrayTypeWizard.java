 ...
 * @author  akaluza
 */
public class CreateVarrayTypeWizard extends SqlCodeWizardPanel {
   ...
   * @param schemaName
   */
  public CreateVarrayTypeWizard(Database database, String schemaName) {
  ...
  public void wizardShow() {
    ...
    template = new Template(Application.get().getOrbadaDatabase()).loadByName(oracle.getValue(OracleTemplatesSettingsProvider.setVarrayType, "oracle-varray-type"));
  }
  
  public String getDialogTitle() {
    return stringManager.getString("CreateVarrayTypeWizard-dialog-title");
  }

  public String getTabTitle() {
    return stringManager.getString("CreateVarrayTypeWizard-tab-title");
  }
  ...
  public String getSqlCode() {
    ...
    if (template == null) {
      return
        "CREATE TYPE " +textName.getText() +" AS VARRAY(" +textSize.getText() +") OF " +
  ...
  private void initComponents() {
    ...
    jLabel4.setText(stringManager.getString("array-length-dd")); // NOI18N
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addGroup(layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(textSize, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE))
          .addGroup(layout.createSequentialGroup()
