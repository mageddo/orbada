 ...
 * @author  akaluza
 */
public class SqlTraceWizard extends SqlCodeWizardPanel {
  ...
  public String getDialogTitle() {
    return stringManager.getString("SqlTraceWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("SqlTraceWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "ALTER " +(checkSystem.isSelected() ? "SYSTEM" : "SESSION") +" SET SQL_TRACE = " +
  ...
  private void initComponents() {
    ...
    jLabel3.setText(stringManager.getString("sql-trace-dd")); // NOI18N
