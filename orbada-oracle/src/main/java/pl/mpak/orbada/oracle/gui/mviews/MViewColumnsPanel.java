 ...
 * @author  akaluza
 */
public class MViewColumnsPanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  public MViewColumnsPanel(IViewAccesibilities accesibilities) {
  ...
  private void init() {
    ...
    try {
      ...
      filter = new SqlFilter(
        accesibilities.getApplication().getSettings(getDatabase().getUserProperties().getProperty("schemaId"), "oracle-mview-columns-filter"),
        cmFilter, buttonFilter, 
        def);
    } catch (Exception ex) {
      ExceptionUtil.processException(ex);
    }
    new ComponentActionsAction(getDatabase(), tableColumns, buttonActions, menuActions, "oracle-mview-columns-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("MViewColumnsPanel-title");
  }
