...
public class TableColumnGrantsPanel extends javax.swing.JPanel implements ITabObjectInfo {
   ...
   */
  public TableColumnGrantsPanel(IViewAccesibilities accesibilities) {
  ...
  private void init() {
    ...
    try {
      tableGrants.addColumn(new QueryTableColumn("grantee", stringManager.getString("grantee"), 150));
      tableGrants.addColumn(new QueryTableColumn("column_name", stringManager.getString("column-name"), 150, new QueryTableCellRenderer(java.awt.Font.BOLD)));
      tableGrants.addColumn(new QueryTableColumn("privilege", stringManager.getString("privilege"), 120, new QueryTableCellRenderer(SwingUtil.Color.GREEN)));
      tableGrants.addColumn(new QueryTableColumn("grantor", stringManager.getString("grantor"), 150));
      tableGrants.addColumn(new QueryTableColumn("grantable", stringManager.getString("grantable"), 70));
    ...
    new ComponentActionsAction(getDatabase(), tableGrants, buttonActions, menuActions, "oracle-table-column-grants-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("TableColumnGrantsPanel-title");
  }
  ...
  public void refresh() {
    try {
      ...
      tableGrants.getQuery().setSqlText(Sql.getColumnPrivilegeList(filter.getSqlText()));
