 ...
 * @author  akaluza
 */
public class FunctionErrorsPanel extends javax.swing.JPanel implements ITabObjectInfo {
   ...
   */
  public FunctionErrorsPanel(IViewAccesibilities accesibilities, String objectType) {
  ...
  private void init() {
    ...
    try {
      tableErrors.addColumn(new QueryTableColumn("line", stringManager.getString("line"), 50));
    ...
    new ComponentActionsAction(getDatabase(), tableErrors, buttonActions, menuActions, "oracle-function-errors-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("FunctionErrorsPanel-title");
  }
...
private void cmGotoSourceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmGotoSourceActionPerformed
  if (tableErrors.getSelectedRow() >= 0) {
    try {
      ...
      FunctionSourcePanel source = (FunctionSourcePanel)SwingUtil.getTabbedPaneComponent(FunctionSourcePanel.class, this);
      if (source != null) {
