 ...
 * @author  akaluza
 */
public class TypeDetailsPanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  public TypeDetailsPanel(IViewAccesibilities accesibilities) {
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), indexInfoPanel.getTable(), buttonActions, menuActions, "oracle-type-details-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("TypeDetailsPanel-title");
  }
  ...
  public void refresh() {
    try {
      ...
      indexInfoPanel.refresh(Sql.getTypeInfo(currentSchemaName, currentTypeName));
    } catch (Exception ex) {
