 ...
 * @author  akaluza
 */
public class IndexSourcePanel extends javax.swing.JPanel implements ITabObjectInfo {
   ...
   */
  public IndexSourcePanel(IViewAccesibilities accesibilities) {
  ...
  public String getTitle() {
    return stringManager.getString("IndexSourcePanel-title");
  }
  ...
  public void refresh() {
    ...
    new SourceCreator(getDatabase(), syntaxSource).getSource(currentSchemaName, "INDEX", currentObjectName);
