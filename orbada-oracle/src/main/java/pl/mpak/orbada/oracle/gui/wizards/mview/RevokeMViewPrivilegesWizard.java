 ...
 * @author  akaluza
 */
public class RevokeMViewPrivilegesWizard extends SqlCodeWizardPanel {
  ...
  public RevokeMViewPrivilegesWizard(Database database, String schemaName, String objectName) {
  ...
  private void init() {
    ...
    comboObject.setModel(new MViewComboBoxModel(database));
    comboObject.addItemListener(new MViewItemListener() {
  ...
  public void wizardShow() {
    ((MViewComboBoxModel)comboObject.getModel()).change(schemaName);
    ((MViewComboBoxModel)comboObject.getModel()).select(objectName, comboObject);
  ...
  private void updateEventList(OracleMViewInfo info) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("RevokeMViewPrivilegesWizard-dialog-title");
  }

  public String getTabTitle() {
    return stringManager.getString("RevokeMViewPrivilegesWizard-tab-title");
  }
