 ...
 * @author akaluza
 */
public class CreateTemporaryTableAction extends Action {
  ...
  private ActionListener createActionListener() {
    return new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        SqlCodeWizardDialog.show(new CreateTemporaryTableWizard(database, OracleDbInfoProvider.getCurrentSchema(database)), true);
      }
    };
  }
