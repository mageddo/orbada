...
import pl.mpak.orbada.oracle.gui.util.FunctionItemListener;
 ...
 * @author  akaluza
 */
public class RevokeFunctionPrivilegesWizard extends SqlCodeWizardPanel {
  ...
  public RevokeFunctionPrivilegesWizard(Database database, String schemaName, String objectName) {
  ...
  private void init() {
    ...
    comboObject.setModel(new FunctionComboBoxModel(database));
    comboObject.addItemListener(new FunctionItemListener() {
      public void itemChanged(OracleFunctionInfo info) {
  ...
  public void wizardShow() {
    ((FunctionComboBoxModel)comboObject.getModel()).change(schemaName);
    ((FunctionComboBoxModel)comboObject.getModel()).select(objectName, comboObject);
  ...
  private void updateEventList(OracleFunctionInfo info) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("RevokeFunctionPrivilegesWizard-dialog-title");
  }

  public String getTabTitle() {
    return stringManager.getString("RevokeFunctionPrivilegesWizard-tab-title");
  }
