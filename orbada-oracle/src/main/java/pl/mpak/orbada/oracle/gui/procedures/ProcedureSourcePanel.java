...
public class ProcedureSourcePanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  public ProcedureSourcePanel(IViewAccesibilities accesibilities, String objectType) {
  ...
  private void init() {
    ...
    SwingUtil.addAction(syntaxSource.getEditorArea(), cmCallProcedure);
    ...
    new ComponentActionsAction(getDatabase(), syntaxSource.getEditorArea(), buttonActions, menuActions, "oracle-procedure-source-actions");
  }
  ...
  private void initComponents() {
    ...
    toolButton1.setAction(cmCallProcedure);
...
private void cmStoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmStoreActionPerformed
  ProcedureErrorsPanel errors = (ProcedureErrorsPanel)SwingUtil.getTabbedPaneComponent(ProcedureErrorsPanel.class, this);
  syntaxSource.getStatusBar().getPanel("ddl-status").setText(stringManager.getString("executing-3d"));
  try {
    syntaxSource.storeObject();
    if (errors != null) {
      errors.refresh();
      ProceduresPanelView view = (ProceduresPanelView)SwingUtil.getOwnerComponent(ProceduresPanelView.class, this);
      if (view != null) {
        view.refresh();
      }
