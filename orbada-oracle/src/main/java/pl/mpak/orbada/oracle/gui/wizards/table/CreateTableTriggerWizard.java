 ...
 * @author  akaluza
 */
public class CreateTableTriggerWizard extends SqlCodeWizardPanel {
  ...
  public String getDialogTitle() {
    return stringManager.getString("CreateTableTriggerWizard-dialog-title");
  }

  public String getTabTitle() {
    return stringManager.getString("CreateTableTriggerWizard-tab-title");
  }
  ...
  public String getSqlCode() {
    ...
    String type =
      ...
      (comboLevel.getSelectedIndex() == 0 ? "\n  FOR EACH ROW" : "") +
      (!StringUtil.isEmpty(textWhen.getText()) ? "\n  WHEN (" +textWhen.getText() +")" : "");
    if (template == null) {
      return
