 ...
 * @author  akaluza
 */
public class GrantTypePrivilegesWizard extends SqlCodeWizardPanel {
  ...
  public GrantTypePrivilegesWizard(Database database, String schemaName, String objectName) {
  ...
  private void init() {
    ...
    comboObject.setModel(new TypeComboBoxModel(database));
    comboObject.addItemListener(new TypeItemListener() {
  ...
  public void wizardShow() {
    ((TypeComboBoxModel)comboObject.getModel()).change(schemaName);
    ((TypeComboBoxModel)comboObject.getModel()).select(objectName, comboObject);
  ...
  public String getDialogTitle() {
    return stringManager.getString("GrantTypePrivilegesWizard-dialog-title");
  }

  public String getTabTitle() {
    return stringManager.getString("GrantTypePrivilegesWizard-tab-title");
  }
