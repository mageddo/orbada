 ...
 * @author  akaluza
 */
public class CopyViewAsTableWizard extends SqlCodeWizardPanel {
  ...
  public CopyViewAsTableWizard(Database database, String schemaName, String viewName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("CopyViewAsTableWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("CopyViewAsTableWizard-tab-title");
  }
  
  public String getSqlCode() {
    String tableName = textName.getText();
    if ("".equals(tableName)) {
      tableName = comboTables.getSelectedItem().toString() +"_" +String.format("%1$tY%1$tm%1$td%1$tH%1$tM%1$tS", new Object[] {System.currentTimeMillis()});
    }
    return
      "CREATE TABLE " +SQLUtil.createSqlName(comboSchemas.getSelectedItem().toString()) +"." +tableName +" AS\n" +
