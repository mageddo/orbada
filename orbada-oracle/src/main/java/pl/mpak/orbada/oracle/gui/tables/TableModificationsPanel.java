 ...
 * @author  akaluza
 */
public class TableModificationsPanel extends javax.swing.JPanel implements ITabObjectInfo {
   ...
   */
  public TableModificationsPanel(IViewAccesibilities accesibilities) {
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), tableInfoPanel.getTable(), buttonActions, menuActions, "oracle-table-modifications-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("TableModificationsPanel-title");
  }
  ...
  public void refresh() {
    try {
      ...
      tableInfoPanel.refresh(Sql.getTableModificationList(currentSchemaName, currentTableName));
    } catch (Exception ex) {
