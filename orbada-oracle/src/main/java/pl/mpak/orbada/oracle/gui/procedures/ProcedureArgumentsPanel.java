...
public class ProcedureArgumentsPanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  private void init() {
    ...
    try {
      ...
      filter = new SqlFilter(
        accesibilities.getApplication().getSettings(getDatabase().getUserProperties().getProperty("schemaId"), "oracle-procedure-arguments-filter"),
        cmFilter, buttonFilter, 
        def);
    } catch (Exception ex) {
      ExceptionUtil.processException(ex);
    }
    new ComponentActionsAction(getDatabase(), tableArguments, buttonActions, menuActions, "oracle-procedure-arguments-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("ProcedureArgumentsPanel-title");
  }
