 ...
 * @author  akaluza
 */
public class RefreshMethodMViewWizard extends SqlCodeWizardPanel {
  ...
  public RefreshMethodMViewWizard(Database database, String schemaName, String viewName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("RefreshMethodMViewWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("RefreshMethodMViewWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "ALTER MATERIALIZED VIEW " +SQLUtil.createSqlName(schemaName, comboTables.getSelectedItem().toString()) +
      " REFRESH " +comboState.getSelectedItem().toString();
  }
  ...
  private void initComponents() {
    ...
    comboState.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "FORCE", "FAST", "COMPLETE" }));
