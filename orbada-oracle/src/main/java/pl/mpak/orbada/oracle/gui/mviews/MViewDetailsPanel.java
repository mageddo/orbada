 ...
 * @author  akaluza
 */
public class MViewDetailsPanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  public MViewDetailsPanel(IViewAccesibilities accesibilities) {
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), tableInfoPanel.getTable(), buttonActions, menuActions, "oracle-mview-details-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("MViewDetailsPanel-title");
  }
  ...
  public void refresh() {
    try {
      ...
      tableInfoPanel.refresh(Sql.getMViewInfo(currentSchemaName, currentViewName));
    } catch (Exception ex) {
