 ...
 * @author  akaluza
 */
public class QueryRewriteIntegrityWizard extends SqlCodeWizardPanel {
  
  private final StringManager stringManager = StringManagerFactory.getStringManager("oracle");

  private Database database;
  
  public QueryRewriteIntegrityWizard(Database database) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("QueryRewriteIntegrityWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("QueryRewriteIntegrityWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "ALTER " +(checkSystem.isSelected() ? "SYSTEM" : "SESSION") +" SET QUERY_REWRITE_INTEGRITY = " +
  ...
  private void initComponents() {
    ...
    jLabel3.setText(stringManager.getString("query-rewrite-integrity-dd")); // NOI18N

    comboState.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ENFORCED", "TRUSTED", "STALE_TOLERATED" }));
