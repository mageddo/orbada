...
public class ViewSourcePanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  private void setEditorText(final String text) {
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        syntaxSource.setDatabaseObject(currentSchemaName, "VIEW", currentObjectName, text);
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), syntaxSource.getEditorArea(), buttonActions, menuActions, "oracle-view-source-actions");
  }
  ...
  public void refresh() {
    ...
    new SourceCreator(getDatabase(), syntaxSource).getSource(currentSchemaName, "VIEW", currentObjectName);
  }
