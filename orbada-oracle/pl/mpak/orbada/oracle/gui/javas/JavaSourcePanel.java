 ...
 * @author  akaluza
 */
public class JavaSourcePanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  public JavaSourcePanel(IViewAccesibilities accesibilities, String objectType) {
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), syntaxSource.getEditorArea(), buttonActions, menuActions, "oracle-java-source-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("JavaSourcePanel-title");
  }
  ...
  private void initComponents() {
    ...
    syntaxSource = new pl.mpak.orbada.gui.comps.OrbadaJavaSyntaxTextArea();
...
private void cmStoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmStoreActionPerformed
  JavaSourceErrorsPanel errors = (JavaSourceErrorsPanel)SwingUtil.getTabbedPaneComponent(JavaSourceErrorsPanel.class, this);
  syntaxSource.getStatusBar().getPanel("ddl-status").setText(stringManager.getString("executing-3d"));
  try {
    syntaxSource.storeObject();
    if (errors != null) {
      errors.refresh();
      JavaSourcesPanelView view = (JavaSourcesPanelView)SwingUtil.getOwnerComponent(JavaSourcesPanelView.class, this);
      if (view != null) {
        view.refresh();
      }
  ...
  private pl.mpak.orbada.gui.comps.OrbadaJavaSyntaxTextArea syntaxSource;
