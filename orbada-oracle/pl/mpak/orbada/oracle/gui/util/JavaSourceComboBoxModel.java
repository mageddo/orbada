 ...
 * @author akaluza
 */
public class JavaSourceComboBoxModel extends DefaultComboBoxModel {
  
  private Database database;
  private String schemaName;
  private DbDatabaseInfo info;
  
  public JavaSourceComboBoxModel(Database database) {
    super();
  ...
  public JavaSourceComboBoxModel(Database database, String schemaName) {
    this(database);
    change(schemaName);
  }
  ...
  public void change(String schemaName) {
    ...
    removeAllElements();
    DbObjectIdentified list = info.getObjectInfo("/SCHEMAS/" +this.schemaName +"/JAVA SOURCES");
    list.saveRefresh();
