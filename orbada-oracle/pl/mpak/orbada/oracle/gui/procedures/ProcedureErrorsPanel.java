 ...
 * @author  akaluza
 */
public class ProcedureErrorsPanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  public ProcedureErrorsPanel(IViewAccesibilities accesibilities, String objectType) {
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), tableErrors, buttonActions, menuActions, "oracle-procedure-errors-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("ProcedureErrorsPanel-title");
  }
...
private void cmGotoSourceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmGotoSourceActionPerformed
  if (tableErrors.getSelectedRow() >= 0) {
    try {
      ...
      ProcedureSourcePanel source = (ProcedureSourcePanel)SwingUtil.getTabbedPaneComponent(ProcedureSourcePanel.class, this);
      if (source != null) {
