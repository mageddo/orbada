 ...
 * @author  akaluza
 */
public class TableSizePanel extends javax.swing.JPanel implements ITabObjectInfo {
   ...
   */
  public TableSizePanel(IViewAccesibilities accesibilities) {
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), tableInfoPanel.getTable(), buttonActions, menuActions, "oracle-table-size-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("TableSizePanel-title");
  }
  ...
  public void refresh() {
    try {
      ...
      if ("true".equalsIgnoreCase(getDatabase().getUserProperties().getProperty("dba-role", "false"))) {
        tableInfoPanel.refresh(Sql.getDbaSegmentSizeList("TABLE", currentSchemaName, currentTableName));
      }
      else {
        tableInfoPanel.refresh(Sql.getSegmentSizeList("TABLE", currentTableName));
      }
    } catch (Exception ex) {
