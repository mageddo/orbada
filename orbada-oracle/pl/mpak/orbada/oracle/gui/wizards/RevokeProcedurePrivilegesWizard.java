...
import pl.mpak.orbada.oracle.gui.util.ProcedureComboBoxModel;
import pl.mpak.orbada.oracle.gui.util.ProcedureItemListener;
...
public class RevokeProcedurePrivilegesWizard extends SqlCodeWizardPanel {
  ...
  public RevokeProcedurePrivilegesWizard(Database database, String schemaName, String objectName) {
  ...
  private void init() {
    ...
    comboObject.setModel(new ProcedureComboBoxModel(database));
    comboObject.addItemListener(new ProcedureItemListener() {
      public void itemChanged(OracleProcedureInfo info) {
  ...
  public void wizardShow() {
    ((ProcedureComboBoxModel)comboObject.getModel()).change(schemaName);
    ((ProcedureComboBoxModel)comboObject.getModel()).select(objectName, comboObject);
  ...
  private void updateEventList(OracleProcedureInfo info) {
