 ...
 * @author  akaluza
 */
public class RefreshTypeMViewWizard extends SqlCodeWizardPanel {
  ...
  public RefreshTypeMViewWizard(Database database, String schemaName, String viewName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("RefreshTypeMViewWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("RefreshTypeMViewWizard-tab-title");
  }
  ...
  private void initComponents() {
    ...
    comboState.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ON DEMAND", "ON COMMIT" }));
