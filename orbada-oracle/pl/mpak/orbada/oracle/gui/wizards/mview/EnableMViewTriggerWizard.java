 ...
 * @author  akaluza
 */
public class EnableMViewTriggerWizard extends SqlCodeWizardPanel {
  ...
  public void wizardShow() {
    if (objectName != null) {
      ...
      ((MViewComboBoxModel)comboTables.getModel()).select(objectName, comboTables);
    }
    else {
  ...
  public String getDialogTitle() {
    return stringManager.getString("EnableMViewTriggerWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("EnableMViewTriggerWizard-tab-title");
  }
