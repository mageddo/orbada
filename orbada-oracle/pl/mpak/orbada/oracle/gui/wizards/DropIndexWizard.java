 ...
 * @author  akaluza
 */
public class DropIndexWizard extends SqlCodeWizardPanel {
  ...
  public DropIndexWizard(Database database, String schemaName, String tableName, String indexName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("DropIndexWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("DropIndexWizard-tab-title");
  }
  
  public String getSqlCode() {
    return "DROP INDEX " +SQLUtil.createSqlName(schemaName, comboIndexes.getSelectedItem().toString());
  }
