 ...
 * @author  akaluza
 */
public class DropConstraintWizard extends SqlCodeWizardPanel {
  ...
  public DropConstraintWizard(Database database, String schemaName, String tableName, String constraintName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("DropConstraintWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("DropConstraintWizard-tab-title");
  }
  
  public String getSqlCode() {
    return "ALTER TABLE " +SQLUtil.createSqlName(schemaName, comboTables.getSelectedItem().toString()) +
      " DROP CONSTRAINT " +SQLUtil.createSqlName(comboConstraints.getSelectedItem().toString());
  }
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addGroup(layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(comboConstraints, 0, 196, Short.MAX_VALUE)))
        .addContainerGap())
    );
