 ...
 * @author  akaluza
 */
public class CoalasceIndexWizard extends SqlCodeWizardPanel {
  ...
  public CoalasceIndexWizard(Database database, String schemaName, String tableName, String indexName) {
  ...
  private void init() {
    comboIndexes.setModel(new TableIndexComboBoxModel(database));
    ...
    comboTables.addItemListener(new TableItemListener() {
      public void itemChanged(OracleTableInfo info) {
        ((TableIndexComboBoxModel)comboIndexes.getModel()).change(info.getSchema().getName(), info.getName());
      }
    });
  }
  ...
  public void wizardShow() {
    ...
    ((TableIndexComboBoxModel)comboIndexes.getModel()).select(indexName, comboIndexes);
  }
  
  public String getDialogTitle() {
    return stringManager.getString("CoalasceIndexWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("CoalasceIndexWizard-tab-title");
  }
  
  public String getSqlCode() {
    return "ALTER INDEX " +SQLUtil.createSqlName(schemaName, comboIndexes.getSelectedItem().toString()) +" COALASCE";
  }
