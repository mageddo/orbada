 ...
 * @author  akaluza
 */
public class CursorSharingWizard extends SqlCodeWizardPanel {
  
  private final StringManager stringManager = StringManagerFactory.getStringManager(OrbadaOraclePlugin.class);

  private Database database;
  
  public CursorSharingWizard(Database database) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("CursorSharingWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("CursorSharingWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "ALTER " +(checkSystem.isSelected() ? "SYSTEM" : "SESSION") +" SET CURSOR_SHARING = " +
  ...
  private void initComponents() {
    ...
    jLabel3.setText(stringManager.getString("cursor-sharing-dd")); // NOI18N

    comboState.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "SIMILAR", "EXACT", "FORCE" }));
