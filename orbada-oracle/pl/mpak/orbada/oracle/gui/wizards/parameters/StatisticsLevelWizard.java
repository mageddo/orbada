 ...
 * @author  akaluza
 */
public class StatisticsLevelWizard extends SqlCodeWizardPanel {
  
  private final StringManager stringManager = StringManagerFactory.getStringManager(OrbadaOraclePlugin.class);

  private Database database;
  
  public StatisticsLevelWizard(Database database) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("StatisticsLevelWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("StatisticsLevelWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "ALTER " +(checkSystem.isSelected() ? "SYSTEM" : "SESSION") +" SET STATISTICS_LEVEL = " +
  ...
  private void initComponents() {
    ...
    jLabel3.setText(stringManager.getString("statistics-level-dd")); // NOI18N

    comboState.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ALL", "TYPICAL", "BASIC" }));
    ...
    layout.setHorizontalGroup(
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addComponent(comboState, 0, 213, Short.MAX_VALUE))
        .addContainerGap())
    );
