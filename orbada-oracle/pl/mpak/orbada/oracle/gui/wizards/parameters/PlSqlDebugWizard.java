 ...
 * @author  akaluza
 */
public class PlSqlDebugWizard extends SqlCodeWizardPanel {
  
  private final StringManager stringManager = StringManagerFactory.getStringManager(OrbadaOraclePlugin.class);

  private Database database;
  
  public PlSqlDebugWizard(Database database) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("PlSqlDebugWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("PlSqlDebugWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "ALTER " +(checkSystem.isSelected() ? "SYSTEM" : "SESSION") +" SET PLSQL_DEBUG = " +
  ...
  private void initComponents() {
    ...
    jLabel3.setText(stringManager.getString("plsql-debug-dd")); // NOI18N
