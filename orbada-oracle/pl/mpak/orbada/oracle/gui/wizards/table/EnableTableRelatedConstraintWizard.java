 ...
 * @author  akaluza
 */
public class EnableTableRelatedConstraintWizard extends SqlCodeWizardPanel {
  ...
  public String getDialogTitle() {
    return stringManager.getString("EnableTableRelatedConstraintWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("EnableTableRelatedConstraintWizard-tab-title");
  }
  ...
  public String getSqlCode() {
    return
      ...
      "               AND PK.OWNER = '" +schemaName +"'\n" +
      "               AND FK.R_CONSTRAINT_NAME = PK.CONSTRAINT_NAME\n" +
      "               AND PK.TABLE_NAME = '" +comboTables.getSelectedItem().toString() +"') LOOP\n" +
