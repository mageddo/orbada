...
public class GrantTablePrivilegesWizard extends SqlCodeWizardPanel {
  ...
  private static String[] privileges = {
    "ALTER", "DELETE", "INDEX", "INSERT", "UPDATE", "SELECT",
    "REFERENCES", "ON COMMIT REFRESH", "QUERY REWRITE", "DEBUG", "FLASHBACK"
  };

  public GrantTablePrivilegesWizard(Database database, String schemaName, String objectName) {
  ...
  private void init() {
    ...
    comboObject.setModel(new TableComboBoxModel(database));
    comboObject.addItemListener(new TableItemListener() {
  ...
  public void wizardShow() {
    ((TableComboBoxModel)comboObject.getModel()).change(schemaName);
    ((TableComboBoxModel)comboObject.getModel()).select(objectName, comboObject);
  ...
  private void updateEventList(OracleTableInfo info) {
  ...
  private void initComponents() {
    ...
    cmMoveAllRight.setText(stringManager.getString("cmMoveRight-text")); // NOI18N
    ...
    checkAll.setText(stringManager.getString("all-dd")); // NOI18N
