 ...
 * @author  akaluza
 */
public class EnableAllTableTriggersWizard extends SqlCodeWizardPanel {
  ...
  public EnableAllTableTriggersWizard(Database database, String schemaName, String tableName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("EnableAllTableTriggersWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("EnableAllTableTriggersWizard-tab-title");
  }
  
  public String getSqlCode() {
    return "ALTER TABLE " +SQLUtil.createSqlName(schemaName, comboTables.getSelectedItem().toString()) +" " +comboState.getSelectedItem().toString() +" ALL TRIGGERS";
  }
