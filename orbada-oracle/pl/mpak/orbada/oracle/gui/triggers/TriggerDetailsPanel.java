 ...
 * @author  akaluza
 */
public class TriggerDetailsPanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  public TriggerDetailsPanel(IViewAccesibilities accesibilities) {
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), indexInfoPanel.getTable(), buttonActions, menuActions, "oracle-trigger-details-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("TriggerDetailsPanel-title");
  }
  ...
  public void refresh() {
    try {
      ...
      indexInfoPanel.refresh(Sql.getTriggerInfo(currentSchemaName, currentTriggerName));
    } catch (Exception ex) {
