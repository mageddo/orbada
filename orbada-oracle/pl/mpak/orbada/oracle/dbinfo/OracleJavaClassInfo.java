 ...
 * @author akaluza
 */
public class OracleJavaClassInfo extends DbObjectContainer implements DbObjectInfo {
  
  private String status;
  private Timestamp created;
  
  public OracleJavaClassInfo(String name, OracleJavaClassListInfo owner) {
    super(name, owner);
  }
