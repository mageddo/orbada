 ...
 * @author akaluza
 */
public class OracleProcedureInfo extends DbObjectContainer implements DbObjectInfo {
  
  private String status;
  
  public OracleProcedureInfo(String name, OracleProcedureListInfo owner) {
    super(name, owner);
  }
  ...
  public void refresh() throws Exception {
    ...
    try {
      clear();
      put(new OracleProcedureArgumentListInfo(this));
