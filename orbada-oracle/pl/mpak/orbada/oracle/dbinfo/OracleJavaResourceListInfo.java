 ...
 * @author akaluza
 */
public class OracleJavaResourceListInfo extends DbObjectContainer<OracleJavaResourceInfo> {
  
  public OracleJavaResourceListInfo(OracleSchemaInfo owner) {
    super("JAVA RESOURCES", owner);
  }
  ...
  public void refresh() throws Exception {
    ...
    try {
      ...
      try {
        ...
        query.paramByName("object_type").setString("JAVA RESOURCE");
        query.open();
        while (!query.eof()) {
          OracleJavaResourceInfo info = new OracleJavaResourceInfo(query.fieldByName("object_name").getString(), this);
