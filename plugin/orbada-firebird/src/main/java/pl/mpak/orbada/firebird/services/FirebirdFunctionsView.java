...
import pl.mpak.orbada.firebird.gui.functions.FunctionsPanelView;
 ...
 * @author akaluza
 */
public class FirebirdFunctionsView extends ViewProvider {
  ...
  public String getPublicName() {
    return stringManager.getString("FirebirdFunctionsView-public-name");
  }
  
  public String getViewId() {
    return "orbada-firebird-functions-view";
  }
  ...
  public String getDescription() {
    return stringManager.getString("FirebirdFunctionsView-description");
  }
