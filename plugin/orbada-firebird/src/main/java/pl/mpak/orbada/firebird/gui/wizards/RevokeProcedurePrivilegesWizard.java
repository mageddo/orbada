 ...
 * @author  akaluza
 */
public class RevokeProcedurePrivilegesWizard extends SqlCodeWizardPanel {
  ...
  public RevokeProcedurePrivilegesWizard(Database database, String objectName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("RevokeProcedurePrivilegesWizard-dialog-title");
  }

  public String getTabTitle() {
    return stringManager.getString("RevokeProcedurePrivilegesWizard-tab-title");
  }
  ...
  public String getSqlCode() {
    ...
    return 
      "REVOKE" +(checkGrantOption.isSelected() ? " GRANT OPTION FOR" : "") +
      " EXECUTE ON PROCEDURE " +SQLUtil.createSqlName(comboObjects.getText()) +
      " FROM " +object;
  }
  ...
  private void initComponents() {
    ...
    jLabel5.setText(stringManager.getString("RevokeProcedurePrivilegesWizard-privilege-for-object-dd")); // NOI18N

    groupObject.add(radioUser);
    radioUser.setSelected(true);
    radioUser.setText(stringManager.getString("RevokeProcedurePrivilegesWizard-for-user")); // NOI18N

    comboUsers.setEditable(true);

    groupObject.add(radioProcedure);
    radioProcedure.setText(stringManager.getString("RevokeProcedurePrivilegesWizard-for-procedure")); // NOI18N

    groupObject.add(radioTrigger);
    radioTrigger.setText(stringManager.getString("RevokeProcedurePrivilegesWizard-for-trigger")); // NOI18N

    groupObject.add(radioView);
    radioView.setText(stringManager.getString("RevokeProcedurePrivilegesWizard-for-view")); // NOI18N

    checkGrantOption.setText(stringManager.getString("RevokeProcedurePrivilegesWizard-grant-option")); // NOI18N
