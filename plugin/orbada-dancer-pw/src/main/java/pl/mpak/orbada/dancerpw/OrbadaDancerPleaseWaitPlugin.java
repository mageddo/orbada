package pl.mpak.orbada.dancerpw;

import java.util.ArrayList;
import java.util.List;
import pl.mpak.orbada.dancerpw.services.DancerPleaseWaitRenderer;
...
public class OrbadaDancerPleaseWaitPlugin extends OrbadaPlugin {
  ...
  public String getInternalName() {
    return "OrbadaDancerPleaseWaitPlugin";
  }
  ...
  public String getUniqueID() {
    return "orbada-dancer-please-wait-plugin";
  }
  ...
  public void initialize() {
    classList.add(DancerPleaseWaitRenderer.class);
  }
