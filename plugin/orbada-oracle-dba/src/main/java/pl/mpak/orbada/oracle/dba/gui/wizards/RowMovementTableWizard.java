 ...
 * @author  akaluza
 */
public class RowMovementTableWizard extends SqlCodeWizardPanel {
  ...
  public RowMovementTableWizard(Database database, String schemaName, String tableName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("RowMovementTableWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("RowMovementTableWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "ALTER TABLE " +SQLUtil.createSqlName(schemaName, comboTables.getSelectedItem().toString()) +
      " " +comboState.getSelectedItem().toString() +" ROW MOVEMENT";
  }
