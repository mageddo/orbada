 ...
 * @author  akaluza
 */
public class CacheTableWizard extends SqlCodeWizardPanel {
   ...
   * @param tableName
   */
  public CacheTableWizard(Database database, String schemaName, String tableName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("CacheTableWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("CacheTableWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "ALTER TABLE " +SQLUtil.createSqlName(schemaName, comboTables.getSelectedItem().toString()) +
      " " +comboCache.getSelectedItem().toString();
  }
  ...
  private void initComponents() {
    ...
    comboCache = new javax.swing.JComboBox();
    ...
    comboCache.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "CACHE", "NOCACHE" }));
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addGroup(layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(comboCache, 0, 196, Short.MAX_VALUE)))
        .addContainerGap())
    );
    layout.setVerticalGroup(
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
          ...
          .addComponent(comboCache, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
  ...
  private javax.swing.JComboBox comboCache;
