 ...
 * @author  akaluza
 */
public class RebuildIndexWizard extends SqlCodeWizardPanel {
  ...
  public RebuildIndexWizard(Database database, String schemaName, String tableName, String indexName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("RebuildIndexWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("RebuildIndexWizard-tab-title");
  }
  ...
  private void initComponents() {
    ...
    jLabel3.setText(stringManager.getString("index-dd")); // NOI18N
