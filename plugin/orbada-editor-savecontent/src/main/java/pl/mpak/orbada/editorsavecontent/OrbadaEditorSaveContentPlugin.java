package pl.mpak.orbada.editorsavecontent;

import java.util.List;
import pl.mpak.orbada.editorsavecontent.services.EditorSaveContentService;
...
public class OrbadaEditorSaveContentPlugin extends OrbadaPlugin {
  ...
  public String getInternalName() {
    return "OrbadaEditorSaveContentPlugin";
  }
  ...
  public String getDescriptiveName() {
    return String.format(stringManager.getString("OrbadaEditorSaveContentPlugin-descriptive-name"), new Object[] {getVersion()});
  }
  ...
  public String getUniqueID() {
    return "orbada-editor-save-content-plugin";
  }
  ...
  public Class<IPluginProvider>[] getProviderArray() {
    return new Class[] {
      EditorSaveContentService.class
    };
  }
