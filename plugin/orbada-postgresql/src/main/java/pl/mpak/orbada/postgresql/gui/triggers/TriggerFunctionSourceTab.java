...
public class TriggerFunctionSourceTab extends UniversalSourceTab implements ITabObjectUserData {
  ...
  public TriggerFunctionSourceTab(IViewAccesibilities accesibilities) {
    super(accesibilities);
  }

  @Override
  public String getPanelName() {
    return "postgresql-trigger-function-source";
  }
    ...
    try {
      if (mapValues != null) {
        new SourceCreator(getDatabase(), textArea).getSource(
          currentSchemaName, "TRIGGER FUNCTION",
          mapValues.get("full_function_name").getString(),
          null);
      }
      else {
  ...
  public String getTitle() {
    return stringManager.getString("function-source");
  }
