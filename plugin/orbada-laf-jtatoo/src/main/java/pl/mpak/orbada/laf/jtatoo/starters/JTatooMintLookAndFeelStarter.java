 ...
 * @author akaluza
 */
public class JTatooMintLookAndFeelStarter extends JTatooLookAndFeelStarter {
  ...
  public void start() throws UnsupportedLookAndFeelException, ClassNotFoundException, InstantiationException, IllegalAccessException {
    applySettings("com.jtattoo.plaf.mint.MintLookAndFeel", JTatooMintLookAndFeelService.lookAndFeelId);
  }
