 ...
 * @author akaluza
 */
public class JTatooFastLookAndFeelStarter extends JTatooLookAndFeelStarter {
  ...
  public void start() throws UnsupportedLookAndFeelException, ClassNotFoundException, InstantiationException, IllegalAccessException {
    applySettings("com.jtattoo.plaf.fast.FastLookAndFeel", JTatooFastLookAndFeelService.lookAndFeelId);
  }
