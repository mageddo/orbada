 ...
 * @author akaluza
 */
public class JTatooAeroLookAndFeelStarter extends JTatooLookAndFeelStarter {
  ...
  public void start() throws UnsupportedLookAndFeelException, ClassNotFoundException, InstantiationException, IllegalAccessException {
    applySettings("com.jtattoo.plaf.aero.AeroLookAndFeel", JTatooAeroLookAndFeelService.lookAndFeelId);
  }
