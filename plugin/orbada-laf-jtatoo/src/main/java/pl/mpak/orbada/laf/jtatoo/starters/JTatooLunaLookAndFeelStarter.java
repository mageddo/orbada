 ...
 * @author akaluza
 */
public class JTatooLunaLookAndFeelStarter extends JTatooLookAndFeelStarter {
  ...
  public void start() throws UnsupportedLookAndFeelException, ClassNotFoundException, InstantiationException, IllegalAccessException {
    applySettings("com.jtattoo.plaf.luna.LunaLookAndFeel", JTatooLunaLookAndFeelService.lookAndFeelId);
  }
