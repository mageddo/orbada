...
public class FunctionsPanelView extends UniversalViewTabs {
  ...
  public QueryTableColumn[] getTableColumns() {
    return new QueryTableColumn[] {
      new QueryTableColumn("routine_name", stringManager.getString("function-name"), 150, new QueryTableCellRenderer(java.awt.Font.BOLD)),
  ...
  public SqlFilterDefComponent[] getFilterDefComponent() {
    return new SqlFilterDefComponent[] {
      new SqlFilterDefComponent("routine_name", stringManager.getString("function-name"), (String[])null),
