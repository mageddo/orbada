 ...
 * @author  akaluza
 */
public class TypeSourcePanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), syntaxSource.getEditorArea(), buttonActions, menuActions, "oracle-type-source-actions");
  ...
  public String getTitle() {
    return stringManager.getString("TypeSourcePanel-title");
  }
...
private void cmStoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmStoreActionPerformed
  TypeErrorsPanel errors = (TypeErrorsPanel)SwingUtil.getTabbedPaneComponent(TypeErrorsPanel.class, this);
  syntaxSource.getStatusBar().getPanel("ddl-status").setText(stringManager.getString("executing-3d"));
  try {
    syntaxSource.storeObject();
    if (errors != null) {
      errors.refresh();
      TypesPanelView view = (TypesPanelView)SwingUtil.getOwnerComponent(TypesPanelView.class, this);
      if (view != null) {
        view.refresh();
      }
