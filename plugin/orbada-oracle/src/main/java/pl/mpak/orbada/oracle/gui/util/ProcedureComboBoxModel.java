 ...
 * @author akaluza
 */
public class ProcedureComboBoxModel extends DefaultComboBoxModel {
  
  private Database database;
  private String schemaName;
  private DbDatabaseInfo info;
  
  public ProcedureComboBoxModel(Database database) {
    super();
  ...
  public ProcedureComboBoxModel(Database database, String schemaName) {
    this(database);
    change(schemaName);
  }
  ...
  public void change(String schemaName) {
    ...
    removeAllElements();
    DbObjectIdentified list = info.getObjectInfo("/SCHEMAS/" +this.schemaName +"/PROCEDURES");
    list.saveRefresh();
  ...
  public void select(String procedureName, JComboBox combo) {
    if (procedureName != null) {
      for (int i=0; i<getSize(); i++) {
        if (getElementAt(i).equals(procedureName)) {
