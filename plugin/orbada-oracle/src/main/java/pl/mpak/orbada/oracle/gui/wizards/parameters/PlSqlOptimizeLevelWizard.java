 ...
 * @author  akaluza
 */
public class PlSqlOptimizeLevelWizard extends SqlCodeWizardPanel {
  
  private final StringManager stringManager = StringManagerFactory.getStringManager("oracle");

  private Database database;
  
  public PlSqlOptimizeLevelWizard(Database database) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("PlSqlOptimizeLevelWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("PlSqlOptimizeLevelWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "ALTER " +(checkSystem.isSelected() ? "SYSTEM" : "SESSION") +" SET PLSQL_OPTIMIZE_LEVEL = " +
  ...
  private void initComponents() {
    ...
    jLabel3.setText(stringManager.getString("plsql-optimize-level-dd")); // NOI18N

    comboState.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "0", "1", "2" }));
