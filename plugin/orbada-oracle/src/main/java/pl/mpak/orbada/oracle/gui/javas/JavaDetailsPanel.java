 ...
 * @author  akaluza
 */
public class JavaDetailsPanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  public JavaDetailsPanel(IViewAccesibilities accesibilities, String objectType) {
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), indexInfoPanel.getTable(), buttonActions, menuActions, "oracle-java-details-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("JavaDetailsPanel-title");
  }
  ...
  public void refresh() {
    try {
      ...
      indexInfoPanel.refresh(Sql.getJavaInfo(currentSchemaName, currentObjectName, objectType));
    } catch (Exception ex) {
