 ...
 * @author  akaluza
 */
public class DropViewWizard extends SqlCodeWizardPanel {
  ...
  public DropViewWizard(Database database, String schemaName, String viewName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("DropViewWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("DropViewWizard-tab-title");
  }
  
  public String getSqlCode() {
    return "DROP VIEW " +SQLUtil.createSqlName(schemaName, comboTables.getSelectedItem().toString());
  }
