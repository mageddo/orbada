 ...
 * @author akaluza
 */
public class OracleJavaSourceInfo extends DbObjectContainer implements DbObjectInfo {
  
  private String status;
  private Timestamp created;
  
  public OracleJavaSourceInfo(String name, OracleJavaSourceListInfo owner) {
    super(name, owner);
  }
