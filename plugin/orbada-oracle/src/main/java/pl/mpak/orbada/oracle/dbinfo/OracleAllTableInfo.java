 ...
 * @author akaluza
 */
public class OracleAllTableInfo extends DbObjectContainer implements DbObjectInfo {
  
  private String tablespaceName;
  private String clusterName;
  
  public OracleAllTableInfo(String name, OracleAllTableListInfo owner) {
    super(name, owner);
  }
  ...
  public Variant[] getMemberValues() {
    return new Variant[] {
      new Variant(clusterName),
      new Variant(tablespaceName),
  ...
  public void refresh() throws Exception {
    ...
    try {
      clear();
      put(new OracleAllTableColumnListInfo(this));
