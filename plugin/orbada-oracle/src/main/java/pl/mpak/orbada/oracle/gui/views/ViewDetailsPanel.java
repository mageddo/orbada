 ...
 * @author  akaluza
 */
public class ViewDetailsPanel extends javax.swing.JPanel implements ITabObjectInfo {
   ...
   */
  public ViewDetailsPanel(IViewAccesibilities accesibilities) {
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), tableInfoPanel.getTable(), buttonActions, menuActions, "oracle-view-details-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("ViewDetailsPanel-title");
  }
  ...
  public void refresh() {
    try {
      ...
      tableInfoPanel.refresh(Sql.getViewInfo(currentSchemaName, currentViewName));
    } catch (Exception ex) {
