 ...
 * @author  akaluza
 */
public class DropMViewWizard extends SqlCodeWizardPanel {
  ...
  public DropMViewWizard(Database database, String schemaName, String viewName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("DropMViewWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("DropMViewWizard-tab-title");
  }
  
  public String getSqlCode() {
    return "DROP MATERIALIZED VIEW " +SQLUtil.createSqlName(schemaName, comboTables.getSelectedItem().toString());
  }
