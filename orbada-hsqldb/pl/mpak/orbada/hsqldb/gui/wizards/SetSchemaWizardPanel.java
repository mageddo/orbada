 ...
 * @author  akaluza
 */
public class SetSchemaWizardPanel extends SqlCodeWizardPanel {
   ...
   * @param schemaName
   */
  public SetSchemaWizardPanel(Database database, String schemaName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("SetSchemaWizardPanel-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("SetSchemaWizardPanel-tab-title");
  }
  
  public String getSqlCode() {
    return "SET SCHEMA " +SQLUtil.createSqlName(comboSchemas.getSelectedItem().toString());
  }
