 ...
 * @author  akaluza
 */
public class ViewColumnPrivilegesPanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  private void init() {
    ...
    try {
      tablePrivileges.addColumn(new QueryTableColumn("column_name", stringManager.getString("column-name"), 150));
      ...
      def.add(new SqlFilterDefComponent("cp.column_name", stringManager.getString("column-name"), (String[])null));
      def.add(new SqlFilterDefComponent("cp.privilege", stringManager.getString("privilege"), (String[])null));
      def.add(new SqlFilterDefComponent("cp.grantor", stringManager.getString("grantor"), (String[])null));
      filter = new SqlFilter(
        accesibilities.getApplication().getSettings(getDatabase().getUserProperties().getProperty("schemaId"), "hsqldb-view-column-privileges-filter"),
  ...
  public void refresh() {
    try {
      ...
      tablePrivileges.getQuery().setSqlText(Sql.getColumnPrivilegeList(filter.getSqlText(), HSqlDbInfoProvider.getVersionTest(getDatabase())));
  ...
  public String getTitle() {
    return stringManager.getString("ViewColumnPrivilegesPanel-title");
  }
