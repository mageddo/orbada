 ...
 * @author  akaluza
 */
public class GrantClassWizardPanel extends SqlCodeWizardPanel {
   ...
   * @param schemaName
   */
  public GrantClassWizardPanel(Database database, String schemaName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("GrantClassWizardPanel-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("GrantClassWizardPanel-tab-title");
  }
  
  public String getSqlCode() {
    return 
      "GRANT ALL ON CLASS \"" +comboClass.getSelectedItem().toString() +"\" TO " +
