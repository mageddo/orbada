package pl.mpak.orbada.datamove;
...
public class OrbadaDataMovePlugin extends OrbadaPlugin {
  ...
  public String getDescriptiveName() {
    return String.format(stringManager.getString("plugin-descriptive-name"), new Object[] {getVersion()});
  }
  ...
  public String getUniqueID() {
    return Consts.orbadaDataMovePluginId;
  }
  ...
  public static String getDefaultPath() {
    return Resolvers.expand("$(orbada.home)") +"/datamoves";
  }
  ...
  public void initialize() {
    new File(getDefaultPath()).mkdirs();
  }
  ...
  public Class<IPluginProvider>[] getProviderArray() {
    return new Class[] {
      ExportMoveDataService.class,
      QueryCreateTableService.class
    };
  }
