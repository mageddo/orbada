package pl.mpak.orbada.mysql.autocomplete;
...
public class OrbadaMySQLAutocompletePlugin extends OrbadaPlugin {
  ...
  public String getInternalName() {
    return "OrbadaMySQLAutocompletePlugin";
  }
  ...
  public String getDescriptiveName() {
    return String.format(stringManager.getString("OrbadaMySQLAutocompletePlugin-descriptive-name"), new Object[] {getVersion()});
  }
  ...
  public String getVersion() {
    return new VersionID(1, 0, 1, 1).toString();
  }
  ...
  public String getUniqueID() {
    return Consts.orbadaMySQLAutocompletePluginId;
  }
  ...
  public void initialize() {
    addDepend(Consts.orbadaMySQLPluginId);
    classList.add(MySQLAutoCompleteDatabaseService.class);
    classList.add(MySQLAutoCompleteService.class);
  }
  ...
  public void processMessage(PluginMessage message) {
    if (message.isMessageId(Consts.globalMessageEditorRefreshInfo)) {
      ...
      if (area != null && area.getDatabase() != null) {
        MySQLAutoCompleteDatabaseService.instance.removeAutoCompleteInfo(area.getDatabase());
      }
    }
  }
