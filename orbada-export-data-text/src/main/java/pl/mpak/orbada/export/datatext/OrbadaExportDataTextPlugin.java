...
public class OrbadaExportDataTextPlugin extends OrbadaPlugin {
  ...
  public String getInternalName() {
    return "OrbadaExportDataTextPlugin";
  }
  ...
  public String getDescriptiveName() {
    return String.format(stringManager.getString("OrbadaExportDataTextPlugin-description-name"), new Object[] {getVersion()});
  }
  ...
  public String getUniqueID() {
    return Consts.orbadaExportDataTextPluginId;
  }
