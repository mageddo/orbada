 ...
 * @author  akaluza
 */
public class QueryExecutionDialog extends javax.swing.JDialog {
  
  private final static StringManager stringManager = StringManagerFactory.getStringManager("system");
  private QueryExecutionPanel queryPanel;
  private QueryExecutedPanel queryExecuted;
  public static boolean showed = false;
  private ISettings settings;
  
  /** Creates new form QueryExecutionDialog */
  public QueryExecutionDialog() {
  ...
  public static void showDialog() {
    QueryExecutionDialog dialog = new QueryExecutionDialog();
    dialog.setVisible(true);
  }
  
  private void init() {
    settings = Application.get().getSettings("orbada-system-query-list-dialog");
    showed = true;
    tabInfo.addTab(stringManager.getString("current"), queryPanel = new QueryExecutionPanel());
    tabInfo.addTab(stringManager.getString("accomplished"), queryExecuted = new QueryExecutedPanel());
    pack();
  ...
  private void initComponents() {
    ...
    setTitle(stringManager.getString("query-execution-dialog-title")); // NOI18N
