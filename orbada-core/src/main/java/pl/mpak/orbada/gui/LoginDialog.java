...
public class LoginDialog extends javax.swing.JDialog {
  ...
  public static LoginInfo show(String userName, String password, String title) {
    return show(new LoginInfo(userName, password), title);
  }
  ...
  private void init(LoginInfo info, String title) {
    ...
    textUserName.setText(StringUtil.equals(info.getUserName(), "") ? "" : info.getUserName());
    textPassword.setText(StringUtil.equals(info.getPassword(), "") ? "" : info.getPassword());
    if (!StringUtil.equals(info.getUserName(), "")) {
  ...
  private void initComponents() {
    ...
    jLabel1.setText(stringManager.getString("LoginDialog-user-name-dd")); // NOI18N

    textUserName.setText("textField1");
          ...
          .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
              .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(textUserName, javax.swing.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE))
              .addGroup(layout.createSequentialGroup()
