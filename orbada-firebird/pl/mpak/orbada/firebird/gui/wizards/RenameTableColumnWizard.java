...
public class RenameTableColumnWizard extends SqlCodeWizardPanel {
  ...
  private final StringManager stringManager = StringManagerFactory.getStringManager(OrbadaFirebirdPlugin.class);

  private Database database;
  private String tableName;
  private String columnName;
  
  public RenameTableColumnWizard(Database database, String tableName, String columnName) {
  ...
  public void wizardShow() {
    textName.setText(SQLUtil.createSqlName(tableName, columnName, database));
  }
  ...
  public String getSqlCode() {
    return
      "ALTER TABLE " +SQLUtil.createSqlName(tableName, database) +
      " ALTER COLUMN " +SQLUtil.createSqlName(columnName, database) +" TO " +textNewName.getText();
  }
