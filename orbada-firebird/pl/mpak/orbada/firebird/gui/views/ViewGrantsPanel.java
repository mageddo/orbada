 ...
 * @author  akaluza
 */
public class ViewGrantsPanel extends javax.swing.JPanel implements ITabObjectInfo {
   ...
   */
  public ViewGrantsPanel(IViewAccesibilities accesibilities) {
  ...
  private void init() {
    ...
    try {
      tableGrants.addColumn(new QueryTableColumn("TABLE_NAME", stringManager.getString("ViewGrantsPanel-object"), 120));
      tableGrants.addColumn(new QueryTableColumn("USER_NAME", stringManager.getString("ViewGrantsPanel-grant-for"), 120));
      tableGrants.addColumn(new QueryTableColumn("PRIVILEGE", stringManager.getString("ViewGrantsPanel-privilege"), 160, new QueryTableCellRenderer(java.awt.Font.BOLD)));
      tableGrants.addColumn(new QueryTableColumn("GRANTOR", stringManager.getString("ViewGrantsPanel-grantor"), 120));
      tableGrants.addColumn(new QueryTableColumn("GRANT_OPTION", stringManager.getString("ViewGrantsPanel-grant-option"), 70, new QueryTableCellRenderer(new QueryTableCellRendererFilter() {
      ...
      tableGrants.addColumn(new QueryTableColumn("TYPE_NAME", stringManager.getString("ViewGrantsPanel-object-type"), 120));
      SqlFilterDef def = new SqlFilterDef();
      def.add(new SqlFilterDefComponent("PRIVILEGE", stringManager.getString("ViewGrantsPanel-privilege"), (String[])null));
      def.add(new SqlFilterDefComponent("USER_NAME", stringManager.getString("ViewGrantsPanel-grant-for"), (String[])null));
    ...
    new ComponentActionsAction(getDatabase(), tableGrants, buttonActions, menuActions, "firebird-view-grants-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("ViewGrantsPanel-title");
  }
  ...
  private void initComponents() {
    ...
    cmGrant.setText(stringManager.getString("ViewGrantsPanel-cmGrant-text")); // NOI18N
    ...
    cmRevoke.setText(stringManager.getString("ViewGrantsPanel-cmRevoke-text")); // NOI18N
...
private void cmGrantActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmGrantActionPerformed
  if (SqlCodeWizardDialog.show(new GrantTablePrivilegesWizard(getDatabase(), currentTableName), true) != null) {
    refresh();
  }
...
private void cmRevokeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmRevokeActionPerformed
  if (SqlCodeWizardDialog.show(new RevokeTablePrivilegesWizard(getDatabase(), currentTableName), true) != null) {
    refresh();
  }
