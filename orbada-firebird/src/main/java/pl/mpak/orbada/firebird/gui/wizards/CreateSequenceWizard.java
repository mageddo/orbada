...
public class CreateSequenceWizard extends SqlCodeWizardPanel {
  ...
  public CreateSequenceWizard(Database database) {
  ...
  public String getSqlCode() {
    ...
    return 
      "CREATE GENERATOR " +textName.getText() +"\n/\n" +
      ("".equals(textStart.getText()) ? "" : "ALTER SEQUENCE " +textName.getText() +" RESTART WITH " +textStart.getText() +"\n/\n");
  }
