...
public class ProcedureSourcePanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  private void setEditorText(final String objectName, final String text) {
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        syntaxSource.setDatabaseObject(null, "PROCEDURE", objectName, text);
  ...
  private void init() {
    ...
    new ComponentActionsAction(getDatabase(), syntaxSource.getEditorArea(), buttonActions, menuActions, "firebird-procedure-source-actions");
  }
  
  public boolean isChanged() {
    return syntaxSource.isChanged();
  }
  ...
  public void refresh() {
    ...
    new SourceCreator(getDatabase(), syntaxSource).getSource(null, "PROCEDURE", currentObjectName);
  ...
  private void initComponents() {
    ...
    cmStore.setText(stringManager.getString("ProcedureSourcePanel-cmStore-text")); // NOI18N
...
private void cmStoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmStoreActionPerformed
  syntaxSource.getStatusBar().getPanel("ddl-status").setText(" " +String.format(stringManager.getString("ProcedureSourcePanel-store"), new Object[] {currentObjectName}));
  try {
    syntaxSource.storeObject();
    syntaxSource.getStatusBar().getPanel("ddl-status").setText(" " +String.format(stringManager.getString("ProcedureSourcePanel-stored"), new Object[] {currentObjectName}));
  }
  catch (Exception ex) {
    syntaxSource.getStatusBar().getPanel("ddl-status").setText(" " +String.format(stringManager.getString("ProcedureSourcePanel-error"), new Object[] {currentObjectName}));
