...
public class TableGrantsPanel extends javax.swing.JPanel implements ITabObjectInfo {
  ...
  private void init() {
    ...
    try {
      tableGrants.addColumn(new QueryTableColumn("TABLE_NAME", stringManager.getString("TableGrantsPanel-object"), 120));
      tableGrants.addColumn(new QueryTableColumn("USER_NAME", stringManager.getString("TableGrantsPanel-grant-for"), 120));
      tableGrants.addColumn(new QueryTableColumn("PRIVILEGE", stringManager.getString("TableGrantsPanel-privilege"), 160, new QueryTableCellRenderer(java.awt.Font.BOLD)));
      tableGrants.addColumn(new QueryTableColumn("GRANTOR", stringManager.getString("TableGrantsPanel-grantor"), 120));
      tableGrants.addColumn(new QueryTableColumn("GRANT_OPTION", stringManager.getString("TableGrantsPanel-grant-option"), 70, new QueryTableCellRenderer(new QueryTableCellRendererFilter() {
      ...
      tableGrants.addColumn(new QueryTableColumn("TYPE_NAME", stringManager.getString("TableGrantsPanel-object-type"), 120));
      SqlFilterDef def = new SqlFilterDef();
      def.add(new SqlFilterDefComponent("PRIVILEGE", stringManager.getString("TableGrantsPanel-privilege"), (String[])null));
      def.add(new SqlFilterDefComponent("USER_NAME", stringManager.getString("TableGrantsPanel-grant-for"), (String[])null));
      filter = new SqlFilter(
        accesibilities.getApplication().getSettings(getDatabase().getUserProperties().getProperty("schemaId"), "firebird-table-grants-filter"),
        cmFilter, buttonFilter, 
        def);
    } catch (Exception ex) {
      ExceptionUtil.processException(ex);
    }
    new ComponentActionsAction(getDatabase(), tableGrants, buttonActions, menuActions, "firebird-table-grants-actions");
  }
  ...
  public String getTitle() {
    return stringManager.getString("TableGrantsPanel-grants");
  }
  ...
  private void initComponents() {
    ...
    cmGrant.setText(stringManager.getString("TableGrantsPanel-cmGrant-text")); // NOI18N
    ...
    cmRevoke.setText(stringManager.getString("TableGrantsPanel-cmRevoke-text")); // NOI18N
