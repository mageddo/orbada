...
public class PluginManagerDialog extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    tableInstalled = new pl.mpak.orbada.gui.comps.table.Table();
    ...
    tablePackages = new pl.mpak.orbada.gui.comps.table.Table();
...
private void textDescriptionHyperlinkUpdate(javax.swing.event.HyperlinkEvent evt) {//GEN-FIRST:event_textDescriptionHyperlinkUpdate
  ...
  private pl.mpak.orbada.gui.comps.table.Table tableInstalled;
  private pl.mpak.orbada.gui.comps.table.Table tablePackages;
