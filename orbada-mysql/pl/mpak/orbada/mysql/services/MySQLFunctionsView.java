 ...
 * @author akaluza
 */
public class MySQLFunctionsView extends ViewProvider {
  ...
  public String getPublicName() {
    return stringManager.getString("MySQLFunctionsView-public-name");
  }
  
  public String getViewId() {
    return "orbada-mysql-functions-view";
  }
  ...
  public String getDescription() {
    return stringManager.getString("MySQLFunctionsView-description");
  }
