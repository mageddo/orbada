...
import pl.mpak.orbada.mysql.gui.views.ViewUtilsPanel;
 ...
 * @author akaluza
 */
public class CheckViewAction extends ComponentAction {

  private final StringManager stringManager = StringManagerFactory.getStringManager(OrbadaMySQLPlugin.class);

  public CheckViewAction() {
    super();
    setActionCommandKey("CheckViewAction");
    setSmallIcon(new javax.swing.ImageIcon(getClass().getResource("/pl/mpak/res/icons/check.gif"))); // NOI18N
    setText(stringManager.getString("cmCheckView-text")); // NOI18N
    ...
    return new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        if (getComponent() instanceof ViewTable) {
          ViewUtilsPanel tab = (ViewUtilsPanel)SwingUtil.getOwnerComponent(ViewUtilsPanel.class, getComponent());
