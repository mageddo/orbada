 ...
 * @author  akaluza
 */
public class OptimyzeTableWizard extends SqlCodeWizardPanel {
  ...
  public OptimyzeTableWizard(Database database, String databaseName, String tableName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("OptimyzeTableWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("OptimyzeTableWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "OPTIMIZE " +comboLogOption.getText().trim() +" TABLE " +SQLUtil.createSqlName(databaseName, tableName, database);
  }
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addGroup(layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(comboLogOption, javax.swing.GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE)))
        .addContainerGap())
    );
