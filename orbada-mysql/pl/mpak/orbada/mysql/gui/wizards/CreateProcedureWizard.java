...
public class CreateProcedureWizard extends SqlCodeWizardPanel {
  ...
  public void wizardShow() {
    ...
    template = new Template(Application.get().getOrbadaDatabase()).loadByName(oracle.getValue(MySQLTemplatesSettingsProvider.setProcedure, "mysql-procedure"));
  ...
  public String getSqlCode() {
    ...
    if (template == null) {
      return
        "CREATE PROCEDURE " +SQLUtil.createSqlName(databaseName, textName.getText(), database) +"(" +
