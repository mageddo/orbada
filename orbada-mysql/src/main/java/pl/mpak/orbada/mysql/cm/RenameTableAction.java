...
import pl.mpak.orbada.mysql.gui.wizards.RenameTableWizard;
 ...
 * @author akaluza
 */
public class RenameTableAction extends ComponentAction {
        ...
        if (getComponent() instanceof ViewTable) {
          ...
          if (vt.getSelectedRow() >= 0) {
            try {
              ...
              RenameTableWizard wizard = new RenameTableWizard(getDatabase(), databaseName, tableName);
