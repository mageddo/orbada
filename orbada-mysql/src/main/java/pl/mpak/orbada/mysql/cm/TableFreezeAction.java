 ...
 * @author akaluza
 */
public class TableFreezeAction extends ComponentAction {

  private final StringManager stringManager = StringManagerFactory.getStringManager(OrbadaMySQLPlugin.class);

  public TableFreezeAction() {
    super();
        ...
        if (getComponent() instanceof ViewTable) {
          ...
          if (vt.getSelectedRow() >= 0) {
            ...
            try {
              ...
              FreezeViewService service = freezeFactory.createInstance("TABLE", databaseName, objectName);
              if (service != null) {
