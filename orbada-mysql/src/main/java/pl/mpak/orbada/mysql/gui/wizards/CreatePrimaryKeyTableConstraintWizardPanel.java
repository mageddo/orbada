 ...
 * @author  akaluza
 */
public class CreatePrimaryKeyTableConstraintWizardPanel extends SqlCodeWizardPanel {
  ...
  public CreatePrimaryKeyTableConstraintWizardPanel(Database database, String databaseName, String tableName) {
    this(database, databaseName, tableName, null);
  }
  
  public CreatePrimaryKeyTableConstraintWizardPanel(Database database, String databaseName, String tableName, String columnName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("CreatePrimaryKeyTableConstraintWizardPanel-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("CreatePrimaryKeyTableConstraintWizardPanel-tab-title");
  }
  ...
  public String getSqlCode() {
    ...
    return
      ...
      " ADD" +(StringUtil.isEmpty(textName.getText()) ? "" : " CONSTRAINT " +textName.getText() +"\n") +
      " PRIMARY KEY" +(StringUtil.isEmpty(comboUsing.getText().trim()) ? "" : (" USING " +comboUsing.getText())) +
      " (" +fkColumns +")" +
  ...
  private void initComponents() {
    ...
    jLabel1.setText(stringManager.getString("primary-key-columns-dd")); // NOI18N
