 ...
 * @author  akaluza
 */
public class CreateTableIndexWizardPanel extends SqlCodeWizardPanel {
  ...
  public CreateTableIndexWizardPanel(Database database, String databaseName, String tableName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("CreateTableIndexWizardPanel-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("CreateTableIndexWizardPanel-tab-title");
  }
  ...
  private void initComponents() {
    ...
    jLabel1.setText(stringManager.getString("index-columns-dd")); // NOI18N
