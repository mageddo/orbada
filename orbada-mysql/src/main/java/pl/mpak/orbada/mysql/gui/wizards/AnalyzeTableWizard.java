 ...
 * @author  akaluza
 */
public class AnalyzeTableWizard extends SqlCodeWizardPanel {
  ...
  public AnalyzeTableWizard(Database database, String databaseName, String tableName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("AnalyzeTableWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("AnalyzeTableWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "ANALYZE " +comboLogOption.getText().trim() +" TABLE " +SQLUtil.createSqlName(databaseName, tableName, database);
  }
