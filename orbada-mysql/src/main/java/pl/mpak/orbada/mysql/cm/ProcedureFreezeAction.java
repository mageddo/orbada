 ...
 * @author akaluza
 */
public class ProcedureFreezeAction extends ComponentAction {

  private final StringManager stringManager = StringManagerFactory.getStringManager(OrbadaMySQLPlugin.class);

  public ProcedureFreezeAction() {
    super();
        ...
        if (getComponent() instanceof ViewTable) {
          ...
          if (vt.getSelectedRow() >= 0) {
            ...
            try {
              ...
              String objectName = vt.getQuery().fieldByName("routine_name").getString();
              FreezeViewService service = freezeFactory.createInstance("PROCEDURE", databaseName, objectName);
              if (service != null) {
