 ...
 * @author akaluza
 */
public class FunctionFreezeAction extends ComponentAction {

  private final StringManager stringManager = StringManagerFactory.getStringManager(OrbadaMySQLPlugin.class);

  public FunctionFreezeAction() {
    super();
        ...
        if (getComponent() instanceof ViewTable) {
          ...
          if (vt.getSelectedRow() >= 0) {
            ...
            try {
              ...
              FreezeViewService service = freezeFactory.createInstance("FUNCTION", databaseName, objectName);
              if (service != null) {
