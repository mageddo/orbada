package pl.mpak.orbada.jsondataview;

import java.util.ArrayList;
import java.util.List;
import pl.mpak.orbada.plugins.OrbadaPlugin;
import pl.mpak.orbada.plugins.queue.PluginMessage;
import pl.mpak.orbada.jsondataview.services.JsonDataViewService;
...
public class OrbadaJsonDataViewPlugin extends OrbadaPlugin {
  ...
  public String getInternalName() {
    return "OrbadaJsonDataViewPlugin";
  }
  ...
  public String getDescriptiveName() {
    return String.format(stringManager.getString("OrbadaJsonDataViewPlugin-descriptive-name"), new Object[] {getVersion()});
  }
  ...
  public String getUniqueID() {
    return "orbada-json-data-view-plugin";
  }
  ...
  public void initialize() {
    classList.add(JsonDataViewService.class);
  }
