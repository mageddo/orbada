...
import pl.mpak.orbada.laf.substance.starters.SubstanceTwilightLookAndFeelStarter;
 ...
 * @author akaluza
 */
public class SubstanceTwilightLookAndFeelService extends LookAndFeelProvider {

  private StringManager stringManager = StringManagerFactory.getStringManager("laf-substance");

  public final static String lookAndFeelId = "substance-twilight-look-and-feel-service";
  ...
  public Class<? extends ILookAndFeelStarter> getLookAndFeelClass() {
    return SubstanceTwilightLookAndFeelStarter.class;
  }

  @Override
  public String getDescription() {
    return "Twilight (Substance)";
  }
