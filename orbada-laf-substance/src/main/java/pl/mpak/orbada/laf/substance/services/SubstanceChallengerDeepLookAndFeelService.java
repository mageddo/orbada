...
import pl.mpak.orbada.laf.substance.starters.SubstanceChallengerDeepLookAndFeelStarter;
 ...
 * @author akaluza
 */
public class SubstanceChallengerDeepLookAndFeelService extends LookAndFeelProvider {

  private StringManager stringManager = StringManagerFactory.getStringManager(OrbadaLafSubstancePlugin.class);

  public final static String lookAndFeelId = "substance-challenger-deep-look-and-feel-service";
  ...
  public Class<? extends ILookAndFeelStarter> getLookAndFeelClass() {
    return SubstanceChallengerDeepLookAndFeelStarter.class;
  }

  @Override
  public String getDescription() {
    return "Challenger Deep (Substance)";
  }
