...
import pl.mpak.orbada.laf.substance.starters.SubstanceDustCoffeeLookAndFeelStarter;
 ...
 * @author akaluza
 */
public class SubstanceDustCoffeeLookAndFeelService extends LookAndFeelProvider {

  private StringManager stringManager = StringManagerFactory.getStringManager(OrbadaLafSubstancePlugin.class);

  public final static String lookAndFeelId = "substance-dust-coffee-look-and-feel-service";
  ...
  public Class<? extends ILookAndFeelStarter> getLookAndFeelClass() {
    return SubstanceDustCoffeeLookAndFeelStarter.class;
  }

  @Override
  public String getDescription() {
    return "Dust Coffee (Substance)";
  }
