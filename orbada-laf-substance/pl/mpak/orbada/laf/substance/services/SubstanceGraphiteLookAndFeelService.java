...
import pl.mpak.orbada.laf.substance.starters.SubstanceGraphiteLookAndFeelStarter;
 ...
 * @author akaluza
 */
public class SubstanceGraphiteLookAndFeelService extends LookAndFeelProvider {

  private StringManager stringManager = StringManagerFactory.getStringManager(OrbadaLafSubstancePlugin.class);

  public final static String lookAndFeelId = "substance-graphite-look-and-feel-service";
  ...
  public Class<? extends ILookAndFeelStarter> getLookAndFeelClass() {
    return SubstanceGraphiteLookAndFeelStarter.class;
  }

  @Override
  public String getDescription() {
    return "Graphite (Substance)";
  }
