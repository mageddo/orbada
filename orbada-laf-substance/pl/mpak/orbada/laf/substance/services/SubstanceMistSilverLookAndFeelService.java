...
import pl.mpak.orbada.laf.substance.starters.SubstanceMistSilverLookAndFeelStarter;
...
public class SubstanceMistSilverLookAndFeelService extends LookAndFeelProvider {
  ...
  public Class<? extends ILookAndFeelStarter> getLookAndFeelClass() {
    return SubstanceMistSilverLookAndFeelStarter.class;
  }

  @Override
  public String getDescription() {
    return "Mist Silver (Substance)";
  }
