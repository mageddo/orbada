...
import pl.mpak.orbada.laf.substance.starters.SubstanceCremeCoffeeLookAndFeelStarter;
 ...
 * @author akaluza
 */
public class SubstanceCremeCoffeeLookAndFeelService extends LookAndFeelProvider {

  private StringManager stringManager = StringManagerFactory.getStringManager(OrbadaLafSubstancePlugin.class);

  public final static String lookAndFeelId = "substance-creme-coffee-look-and-feel-service";
  ...
  public Class<? extends ILookAndFeelStarter> getLookAndFeelClass() {
    return SubstanceCremeCoffeeLookAndFeelStarter.class;
  }

  @Override
  public String getDescription() {
    return "Creme Coffee (Substance)";
  }
