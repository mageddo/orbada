 ...
 * @author  proznicki
 */
public class ExportToExcelDialog extends javax.swing.JDialog {
  ...
  /** Creates new form ExportToExcelDialog
   * @param config
   */
  ...
  private boolean selectFile() {
    ...
    lastFile = FileUtil.selectFileToSave(this, null, null, lastFile, 
            new FileExtensionFilter[] {
              new FileExtensionFilter(stringManager.getString("ExportToExcelDialog-excel-files"), new String[] {".xls"}),
              new FileExtensionFilter(stringManager.getString("ExportToExcelDialog-excel-files-2003"), new String[] {".xlsx"})
            });
    if (lastFile != null) {
  ...
  private void initComponents() {
    ...
    setTitle(stringManager.getString("ExportToExcelDialog-title")); // NOI18N
    setModal(true);
    ...
    jLabel7.setText(stringManager.getString("ExportToExcelDialog-charset-dd")); // NOI18N

    comboCharset.setEditable(true);
    comboCharset.setFont(new java.awt.Font("Courier New", 0, 12));

    jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
    jLabel17.setText(stringManager.getString("ExportToExcelDialog-empty-value-dd")); // NOI18N
