...
public class OrbadaExportExcelPlugin extends OrbadaPlugin {
  ...
  public String getInternalName() {
    return "OrbadaExportExcelPlugin";
  }
  ...
  public String getDescriptiveName() {
    return String.format(stringManager.getString("OrbadaExportExcelPlugin-descriptive-name"), new Object[] {getVersion()});
  }
  ...
  public String getUniqueID() {
    return Consts.orbadaExportExcelPluginId;
  }
