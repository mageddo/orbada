...
public class OrbadaAdderPlugin extends OrbadaPlugin {
  ...
  public String getDescriptiveName() {
    return String.format(stringManager.getString("OrbadaAdderPlugin-descriptive-name"), new Object[] {getVersion()});
  }
  ...
  public String getVersion() {
    return new VersionID(1, 0, 0, 2).toString();
  }
  ...
  public String getUniqueID() {
    return Consts.orbadaAdderPluginId;
  }
