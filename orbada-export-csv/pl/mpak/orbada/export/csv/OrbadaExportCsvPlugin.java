...
public class OrbadaExportCsvPlugin extends OrbadaPlugin {
  ...
  public String getDescriptiveName() {
    return String.format(stringManager.getString("OrbadaExportCsvPlugin-descriptive-name"), new Object[] {getVersion()});
  }
  ...
  public String getUniqueID() {
    return Consts.orbadaExportCsvPluginId;
  }
