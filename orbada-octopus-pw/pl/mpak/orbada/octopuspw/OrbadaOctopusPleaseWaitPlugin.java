package pl.mpak.orbada.octopuspw;

import java.util.ArrayList;
import java.util.List;
import pl.mpak.orbada.octopuspw.services.OctopusPleaseWaitRenderer;
...
public class OrbadaOctopusPleaseWaitPlugin extends OrbadaPlugin {
  ...
  public String getInternalName() {
    return "OrbadaOctopusPleaseWaitPlugin";
  }
  ...
  public String getDescriptiveName() {
    return String.format(stringManager.getString("OrbadaOctopusPleaseWaitPlugin-descriptive-name"), new Object[] {getVersion()});
  }
  ...
  public String getUniqueID() {
    return "orbada-octopus-please-wait-plugin";
  }
  ...
  public void initialize() {
    classList.add(OctopusPleaseWaitRenderer.class);
  }
