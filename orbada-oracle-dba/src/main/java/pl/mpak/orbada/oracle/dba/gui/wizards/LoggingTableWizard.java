 ...
 * @author  akaluza
 */
public class LoggingTableWizard extends SqlCodeWizardPanel {
  ...
  public LoggingTableWizard(Database database, String schemaName, String tableName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("LoggingTableWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("LoggingTableWizard-tab-title");
  }
  ...
  private void initComponents() {
    ...
    comboState.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "LOGGING", "NOLOGGING" }));
