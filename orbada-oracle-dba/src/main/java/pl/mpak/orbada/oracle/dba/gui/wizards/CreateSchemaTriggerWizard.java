 ...
 * @author  akaluza
 */
public class CreateSchemaTriggerWizard extends SqlCodeWizardPanel {
  ...
  private static String[] beforeEvents = {
    ...
    "COMMENT", "CREATE", "DDL", "DISASSOCIATE STATISTICS", "DROP",
    "GRANT", "LOGOFF", "NOAUDIT", "RENAME", "REVOKE", "TRUNCATE"
  };

  private static String[] afterEvents = {
    "ALTER", "ANALYZE", "ASSOCIATE STATISTICS", "AUDIT",
    "COMMENT", "CREATE", "DDL", "DISASSOCIATE STATISTICS",
    "DROP", "GRANT", "LOGON", "NOAUDIT", "RENAME", "REVOKE",
    "SERVERERROR", "SUSPEND", "TRUNCATE"
  };

  public CreateSchemaTriggerWizard(Database database, String schemaName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("CreateSchemaTriggerWizard-dialog-title");
  }

  public String getTabTitle() {
    return stringManager.getString("CreateSchemaTriggerWizard-tab-title");
  }
  ...
  public String getSqlCode() {
    ...
    type = "  " +type +" ON " +SQLUtil.createSqlName(comboSchemas.getSelectedItem().toString()) +".SCHEMA";
    if (template == null) {
      return
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addGroup(layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(comboSchemas, 0, 208, Short.MAX_VALUE))
          .addGroup(layout.createSequentialGroup()
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
