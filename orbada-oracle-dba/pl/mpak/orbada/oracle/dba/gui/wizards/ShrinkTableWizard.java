 ...
 * @author  akaluza
 */
public class ShrinkTableWizard extends SqlCodeWizardPanel {
  ...
  public ShrinkTableWizard(Database database, String schemaName, String tableName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("ShrinkTableWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("ShrinkTableWizard-tab-title");
  }
  ...
  public String getSqlCode() {
    return
      ...
      " SHRINK SPACE" +
      (checkCompact.isSelected() ? " COMPACT" : "") +
      (checkCascade.isSelected() ? " CASCADE" : "");
  }
  ...
  private void initComponents() {
    ...
    checkCompact = new javax.swing.JCheckBox();
    checkCascade = new javax.swing.JCheckBox();

    jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
    jLabel2.setText(stringManager.getString("table-dd")); // NOI18N

    checkCompact.setText(stringManager.getString("compact")); // NOI18N

    checkCascade.setText(stringManager.getString("cascade")); // NOI18N
  ...
  private javax.swing.JCheckBox checkCompact;
