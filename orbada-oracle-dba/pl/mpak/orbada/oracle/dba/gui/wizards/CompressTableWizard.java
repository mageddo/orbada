 ...
 * @author  akaluza
 */
public class CompressTableWizard extends SqlCodeWizardPanel {
  ...
  public CompressTableWizard(Database database, String schemaName, String tableName) {
  ...
  public String getDialogTitle() {
    return stringManager.getString("CompressTableWizard-dialog-title");
  }
  
  public String getTabTitle() {
    return stringManager.getString("CompressTableWizard-tab-title");
  }
  
  public String getSqlCode() {
    return
      "ALTER TABLE " +SQLUtil.createSqlName(schemaName, comboTables.getSelectedItem().toString()) +
      " " +comboCompress.getSelectedItem().toString();
  }
  ...
  private void initComponents() {
    ...
    comboCompress = new javax.swing.JComboBox();
    ...
    comboCompress.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "COMPRESS", "NOCOMPRESS" }));
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addGroup(layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(comboCompress, 0, 196, Short.MAX_VALUE)))
        .addContainerGap())
    );
    layout.setVerticalGroup(
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
          ...
          .addComponent(comboCompress, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
  ...
  private javax.swing.JComboBox comboCompress;
